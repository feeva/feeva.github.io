...
<head>
    ...
    <!-- (c) 2013, Nothing New Under the Sun -->
    <!-- http://start.goodtime.co.kr -->
    <!-- Use this at your own risk -->
    <!-- History -->
    <!-- # 2013-04-14 v1.0 Initial Release -->
    ...
    <meta property="og:url" content="http://start.goodtime.co.kr/programs/timer.php"/>
...
body { font-family: 맑은 고딕, 나눔 고딕, sans-serif; background: #222 none; color: #ddd; }
h1 { font-size: 16pt; }
a { text-decoration: none; }
a:hover { border-bottom-width: 1px; border-bottom-style: solid; }
.ui-widget, .ui-widget button { font-family: 맑은 고딕, 나눔 고딕, sans-serif; }

/* .clearfix는 Bootstrap에서 베낌 */
.clearfix { *zoom: 1; }
.clearfix:before, .clearfix:after { display: table; line-height: 0; content: ""; }
.clearfix:after { clear: both; }

.title { margin-left: 1em; *margin: .5em 0 1em 1em; }
.title h1, .title div { display: inline-block; *display: inline; *zoom: 1; }
.title h1 { margin-right: 2em; }
.title div { vertical-align:middle; }

#content { min-width: 900px; width: 80%; margin: auto; }
#timer { position:relative; margin: auto; text-align: center; padding: 1em; background: black none; }
.digit-label { margin-bottom: .5em;}
.digit-panel { float: left; width: 13%; padding-right: 1em; }
.digit-panel.days { width: 18%;}
.digit-face { position: relative; }
.digit-panel .digit-face span { color: white; font-size: 4.5em; font-family: century gothic, arial, sans-serif; }
.timer-meta { width: 19.8%; float: left; text-align:left; }
.timer-meta dl { margin-top: 1.5em; font-size: 11pt; }
.timer-meta dd { margin-left: 1em; margin-bottom: .5em; }
.timer-meta dd span { color: #9df; cursor:pointer; }
.timer-meta dd span:hover { border-bottom-width: 1px; border-bottom-style: solid; }
#btnStartStop { color: yellow; margin-top: .7em; *margin-top: 1.7em; font-size: 2.5em; padding: .4em .8em; *padding: .2em .8em;}
#btnStartStop.active { color: #ff7700; }
.digit-slider { position: absolute; top: 0; right: 0; bottom: .2em;
    display:none; background: black none; width: 7px; height: auto; }
.digit-slider.ui-slider .ui-slider-handle { width: 1em; height: 1em; }
.marks { margin-top: 1em; }
.marks div { width: 26%; height: .5em; float:left; border: solid 1px #333; margin: 0 0 2% 4%; }
.timer .marks div { cursor:pointer; }
.timer.days .marks div { width: 6.1%; margin: 0 0 1.9% 1%; }

.timer-meta fieldset { position: absolute; border-color: #555; color: #555;
    left: 77.5%; right: 1.5%; bottom: 1.5em; font-size: 9pt; }
.timer-meta fieldset legend { color: #555; margin-left: 1em; }
.timer-meta fieldset ul { *margin-left: .5em; padding-left: 1.5em; }
.timer-meta a { color: #aaa; }

#dialog-target-date { display: none; }
#dialog-target-time { display: none; }
...
?>
    ...
    <meta property="me2:post_body" content='' />
    <meta property="me2:post_tag" content='javascript,자바스크립트,타이머,카운트다운' />
...
<body>
    ...
    <div id="content">
        <div class="title clearfix">
            ...
            <div>
                <iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fstart.goodtime.co.kr%2Fprograms%2Ftimer.php&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;colorscheme=dark&amp;action=like&amp;height=21&amp;appId=370619496297823" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:21px; " allowTransparency="true"></iframe>
            </div>
            
            <div>
                <iframe allowtransparency="true" frameborder="0" scrolling="no"
        src="http://platform.twitter.com/widgets/tweet_button.1363148939.html#_=1366078520169&count=horizontal&id=twitter-widget-0&lang=ko&original_referer=http%3A%2F%2Fstart.goodtime.co.kr%2Fprograms%2Ftimer.php&size=m&text=%EC%B9%B4%EC%9A%B4%ED%8A%B8%EB%8B%A4%EC%9A%B4%20%ED%83%80%EC%9D%B4%EB%A8%B8&url=http%3A%2F%2Fstart.goodtime.co.kr%2Fprograms%2Ftimer.php&via=DylanYi"
        style="width:80px; height:20px;"></iframe>
            </div>
            
            <div>
                <me2:metoo layout="small" profile_images="off" color="light" pingback="unchecked" href="http://start.goodtime.co.kr/programs/timer.php" plugin_key="sOJ1KmYySdWnPmTtT77agg"></me2:metoo>
            </div>
        </div>
            ...
            <div class="timer-meta">
                ...
                <fieldset>
                    ...
                    <ul>
                        ...
                        <li>기타 <a href="http://start.goodtime.co.kr/2013/04/온라인-타이머">제작 후기</a> 참고</li>
                    </ul>
                </fieldset>
        ...
        <div class="footer">(c) 2013, <a href="http://start.goodtime.co.kr">Nothing New Under the Sun</a></div>
    </div>
